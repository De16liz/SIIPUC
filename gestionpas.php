...
<body>
	...
	<div class='row'>
	<center><h1>Datos del ministro</h1></center>
	<div class='col-xs-12 col-md-4 col-lg-4 '>
		
		</div>
		<div class="col-xs-12 col-sm-6 ">	

			<form  action="nuevo_pastor.php" method="POST" autocomplete="off">
				<div style="margin-bottom: 25px" class="input-group">
					<h4>Documento</h4><input type="text" class="form-control" name="id" placeholder="Digite su documento" value="" required="">
				</div>

				<div style="margin-bottom: 25px" class="input-group">
					<label for="usuario" class="col-md-3 control-label"><h4>Numero licencia</h4></label>
					<input type="text" class="form-control" name="Nro_licencia" placeholder="Digite su numero de licencia" value="" required="">
				</div>
				...
				<div style="margin-bottom: 25px" class="input-group">
					<label for="usuario" class="col-md-3 control-label"><h4>correo</h4></label>
					<input type="text" class="form-control" name="correo" placeholder="Digite su correo" value="" required="">
				</div>
